<template>
    <div style="display: flex; background-color: rgb(254 253 234);">
        <div class="program">
            <h2>Our Programs</h2>
...
export default {
    ...
    data: () => ({
        ...
        // Add similar data properties for other cards
    })
}
</script>
...
.custom-subtitle {
    color: #666;
    /* Adjust the subtitle color */
}

.custom-learn {
    color: #A30B37;
    /* Adjust the 'Explore' button text color */
}
